...
<head>
    ...
    <link rel="stylesheet" href="../../resources/css/hospital_id_search1.css" type="text/css">
</head>
<body>
    <div class="container">
        <div class="logo">
        ...
        <form action='hospital_id_search2.jsp' id='myForm' >
        ...
        <div class="signup-content">
            <div class="form-group">
                ...
                <button type="button" class="btn btn-outline-secondary" id="sendcodebotton">인증번호 받기</button>
            </div>
            <div class="form-group">
   ...
   <script src="../../resources/js/jquery-3.7.1.js"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
        	$('#sendcodebotton').click(function(){
        		var email = $('#email').val();
        		$.post('HospitalIdServlet_sendEmail', {email : email}, function(data){
        			if(data == 'success'){
