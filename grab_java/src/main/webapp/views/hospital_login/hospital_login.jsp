...
<head>
   ...
   <!--  <link rel="stylesheet" href="../../resources/css/font-awesome.min.css" type="text/css">
    ...
    <link rel="stylesheet" href="../../resources/css/hospital_login.css" type="text/css">
...
<body>
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#user-login">일반 사용자 로그인</a>
            </li>
            <li class="nav-item">
                <a  class="nav-link" data-toggle="tab" href="#admin-login" >병원 관리자 로그인</a>
            </li>
        </ul>
