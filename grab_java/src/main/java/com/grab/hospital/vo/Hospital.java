...
public class Hospital {
	...
	public Hospital(int hospital_no, String hospital_registration, String hospital_license, String hospital_name,
			String hospital_phone, String hospital_number, String hospital_addr, int hospital_doctor_num,
			String hospital_homepage, int hospital_mapping, String hospital_time, int hospital_price,
			String hospital_whether, int hospital_view, LocalDateTime hospital_login) {
		super();
	...
	public void setHospital_price(int hospital_price) {
		this.hospital_price = hospital_price;
	}
	...
	public String toString() {
		return "Hospital [hospital_no=" + hospital_no + ", hospital_registration=" + hospital_registration
				+ ", hospital_license=" + hospital_license + ", hospital_name=" + hospital_name + ", hospital_phone="
				+ hospital_phone + ", hospital_number=" + hospital_number + ", hospital_addr=" + hospital_addr
				+ ", hospital_doctor_num=" + hospital_doctor_num + ", hospital_homepage=" + hospital_homepage
				+ ", hospital_mapping=" + hospital_mapping + ", hospital_time=" + hospital_time + ", hospital_price="
				+ hospital_price + ", hospital_whether=" + hospital_whether + ", hospital_view=" + hospital_view
